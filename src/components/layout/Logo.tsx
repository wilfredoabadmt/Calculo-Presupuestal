...
export function Logo() {
  return (
    <Link href="/" className="flex items-center gap-2 font-bold text-lg text-primary">
      <div className="relative h-7 w-7 rounded overflow-hidden flex items-center justify-center bg-slate-950/60 border border-slate-850 shrink-0">
      ...
      <span className="truncate">Cálculo Presupuestal</span>
    </Link>
  )
}
