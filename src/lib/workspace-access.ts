...
// Reexportado para mantener compatibilidad con importaciones existentes.
export { isProActive, FREE_PROJECT_LIMIT } from "@/lib/plan"
export type { PlanUser } from "@/lib/plan"
